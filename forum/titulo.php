      ...
      <tr>
        <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
			  ...
			  <A class=linkbranco href="../inicio.php?op_z=wy"><font color="#FFFFFF"> Home </font></a>|
			  ...
			  <A class=linkbranco href="../loja/loja.php?abrir_up=layout.php"><font color="#FFFFFF"> Loja Virtual </font></a>|
				    ...
				    <form name="form1" method="post" autocomplete="off" action="../login_sair.php">
                      ...
                      <tr>
                        <td height="46" align="right"><div align="right"><span class="style4"> <font color="#FF0000">Falha no Login</font> <br>
                               <font color="#000000">Usuario ou Senha Incorretos</font> <br>
				   ...
				   ?>                    
		                  ...
		                  ?>
		                    ...
		                    <form name="form1" method="post" autocomplete="off" action="../logar.php?acao=logar">
		                      ...
		                      <tr>
		                        <td width="113" height="30" valign="bottom"><div align="right"><span class="style1"> <img src="../graphics/px1.gif" width="1" height="1"/><span class="style3"><font color="#000000">login.</font></span><font color="#000000">:<img src="../graphics/px1.gif" width="5" height="1"/></font><img src="../graphics/px1.gif" width="1" height="1"/></span> </div></td>
		                      ...
		                      <tr>
		                        <td height="16" align="right"><div align="right"><span class="style4"> <img src="../graphics/px1.gif" width="1" height="1"/><font color="#000000">senha.:<img src="../graphics/px1.gif" width="5" height="1"/></font></span> </div></td>
		                        <td align="right">
						   ...
						   ?> 
						    ...
						    <form name="form1" method="post" autocomplete="off" action="../login_sair.php">
		                      ...
		                      <tr>
		                        <td height="44" align="right"><div align="right"><span class="style4"> <font color="#000000">Ola.: 
	                            <?=$ser_name3_c;?> 
	                            <br>
...
<?
		...
		?>
				 ...
				 </font><font color="#009999"><i>Se vo&ccedil;&ecirc; n&atilde;o e cadastrado </i></font></span></span> </font><font size="2"><a href="<?=$progr_7;?>"><b><font color="#000000">clique aqui</font></b></a></font> </td>
              </tr>
            </table>
