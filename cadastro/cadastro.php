        ...
        <tr>
          <td bgcolor="#FFCC66">  		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
            <tr>
              ...
              <td width="66%"><input type="text" id="Edit10" name="Edit10" value="" style=" font-family: Verdana; font-size: 10px;  background-color: #FFFFFF;height:20px;width:275px;"    tabindex="0" onblur="ValidaEmail()"   />

                <font color="#FF0000">*</font></td>
            </tr>
            <tr>
              <td height="31"><b><font size="-1" face="Verdana">Comfirmar e-Mails .:</font></b></td>
              <td><input type="text" id="Edit11" name="Edit11" value="" style=" font-family: Verdana; font-size: 10px;  background-color: #FFFFFF;height:20px;width:275px;"    tabindex="0"  onblur="ValidaEmail2()"  />
            ...
            <tr>
              ...
              <td><input type="text" id="Edit25" name="Edit25" value="" style=" font-family: Verdana; font-size: 10px;  background-color: #FFFFFF;height:20px;width:175px;"    tabindex="0"    /></td>
            </tr>
            <tr>
      ...
      <table width="593" border="0">
        <tr>
          <td height="98" bgcolor="#DDDCD9"><table width="100%" border="0">
            ...
            <div align="center"><img src="../graphics/px1.gif" width="20" height="6"></div>
