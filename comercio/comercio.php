...
// Decodificacao do Link
$vazer_y  = decode5t($vazer_y);
$Edit1_xz = decode5t($Edit1_xz);
$faz_nome = decode5t($faz_nome);
...
<table width="100%" border="0">
  <tr>
	...
	<?
	   ...
	   echo "<br><br><center><b>Produto não Encontrado !!!!</b></center><br><br>";
	   echo "<center><a href='../comercio/comercio.php'><img src='../graphics/retorno.png' border='0'/></a></center>";
	   echo "<br><br><br><br><br><br></body>";
...
$consulta4  = "SELECT * FROM tt_ser_01 WHERE login = '$nome_user1'";
...
?>
  ...
  <tr bgcolor="#FFFFCC">
    ...
    <td><span class="style13"><a href='descricao.php?id_prod=<?=encode5t($ID_COD);?>'><?=$nome;?></a></span></td>
