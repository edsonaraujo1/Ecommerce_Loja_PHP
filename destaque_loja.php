...
<?
 ...
 //*********************************************************************
 $sql = "SELECT * FROM produto ORDER BY RAND()"; // LIMIT 0,6
 GeraColunas2(4, $sql);
...
//*********************************************************************
function GeraColunas2($pNumColunas, $pQuery) {
...
echo ("<table width='50' height='60' border='0' cellpadding='0' cellspacing='1' align='center'>\n");
 ...
 $preco = number_format($linha[5],2,",",".");
  ...
  echo "<td align='center'><a href='loja/descricao.php?id_prod=".$cod."'><img src='".$img."' border='0' width='60' height='60' /></a></td>";
  echo "</tr>";
