...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top"><table width="100%" height="164" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="20%" height="17" valign="top" bgcolor="#005151"><div align="center" class="style3">
          </div></td>
          <td width="61%" valign="top" bgcolor="#005151"><div align="center"><span class="style3z"><font color="#FFFFFF">
            <?=$createby;?>
          </font></span></div></td>
  ...
  <A class=linkbranco href="../comercio/comercio.php"><font color="#FFFFFF">Comprar</A> |
  <A class=linkbranco href="../mercado/produto.php"><font color="#FFFFFF">Vender</A> |
  <A class=linkbranco href="../mercado/produto.php"><font color="#FFFFFF">Trocar</A> |
  <A class=linkbranco href="../forum/forum.php"><font color="#FFFFFF">Forum</A> |
  <A class=linkbranco href="../loja/loja.php?abrir_up=layout.php"><font color="#FFFFFF">Loja Vitrine</A> |
  <A class=linkbranco href="../fale/fale.php"><font color="#FFFFFF">Fale Conosco </A> </font></span>
                <DIV class=invisivel>
