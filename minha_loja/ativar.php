...
$consulta_log = "UPDATE produto2  SET situacao     = 'ATIVO',
                                      comprado_por = '$ser_name3_c',
									  comp_em      = '$date1',
									  excluido     = 'NAO'  WHERE codigo = " . decode5t($id_prod). " ";
...
<?
		...
		echo "<center><b>PARABENS Você ATIVOU sua venda com sucesso!</b><br></center>";
		echo "<center><b>".$nome_prod." agora você ja pode negociar novamente</b><br></center>";
		echo "<center><b>esse produto para venda ou troca</b></center>";
		...
		echo "<center><a href='descricao.php?id_prod=". encode5t($id_prod) . "'><img src='../graphics/retorno.png' border='0'/></a></center><br><br><br>";
?>		
</body>
<?
}else{
...
<?    	
		...
		echo "<center><b>um erro de Servidor Reconecte, e tente de novo.</b></center><br><br>";
        echo "<center><a href='descricao.php?id_prod=". encode5t($id_prod). "'><img src='../graphics/retorno.png' border='0'/></a></center><br><br><br>";
