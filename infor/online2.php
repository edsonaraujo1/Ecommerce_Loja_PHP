...
?>
	...
	<table width="131" height="1" border="0" cellpadding="0" cellspacing="1" bordercolor="#FF6600">
  <tr>
        ...
        <tr>
          <td align="left" bgcolor="#D7DFEE"><table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr bgcolor="#D7DFEE">
			  ...
			  <IFRAME src="../infor/user2.php" width="100%" scrolling="no" frameborder="0" align="left"></IFRAME>
