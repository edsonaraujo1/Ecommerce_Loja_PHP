        ...
        <td height="653"><div align="center">
          <table width="570" border="0">
            <tr>
              ...
              <td width="154"><i><font face="Arial"><b>Holodek</b></font></i></td>
              <td width="135"><b><font size="2" face="Verdana">Usuario desde.:</font></b></td>
              <td width="136"><b><i><font face="Arial">01/01/2009</font></i></b></td>
            </tr>
          </table>
            ...
            <tr>
              <td width="593" height="135"><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
                ...
                <tr>
                  ...
                  <td><select type="text" id="select" name="categoria" value="<?=$categoria;?>" style=" font-family: Verdana; font-size: 10px;  background-color: #FFFFFF;height:20px;width:200px;"    tabindex="0"    >
