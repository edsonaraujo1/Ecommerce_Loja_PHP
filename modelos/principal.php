...
<table width="100%" border="1">
  <tr>
    ...
    <td width="87%" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
        <tr>
          <td width="14" align="center" valign="top"><p>&nbsp;</p></td>
          <td width="421" valign="top" bgcolor="#FFFFFF"><span class="style3 style22"> <br>
                <!-- Automatico -->
          ...
          <td width="382" align="center" valign="top"> <span class="style3"><span class="style21"></span></span> <br>
              <?
    ...
    <td width="1%" valign="top"><div align="center">
      <?
	        ...
	        ?>
      <br>
      <img src="../graphics/baner_vertical.PNG" width="141" height="580">    </div></td>
  </tr>
</table>
</body>
</html>
