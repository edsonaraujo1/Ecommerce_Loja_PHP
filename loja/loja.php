...
<table width="100%" border="0">
  <tr>
    <td width="15%" valign="top"><div align="center">
      ...
      <br>
      <img src="../graphics/px1.gif" width="1" height="1"> </div></td>
...
<table width="100%" height="70" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="165" height="70"><b><font size="2" face="Verdana">Tipo de Produto.:&nbsp;</font></b><br>
...
echo ("<table width='50' border='0' align='center'>\n");
 ...
 for ($intCont = 0; $intCont < $pNumColunas; $intCont++) {
  ...
  echo "<form action='carrinho.php?cod=".decode5t($cod)."&acao=incluir' method='POST'>";
