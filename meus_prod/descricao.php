...
//*****************************************                
              ...
              <tr>
                <td><div align="center"><a href="meus_prod.php"><img id="Image4" src="../graphics/ver_fotos_volta.png"  width="166"  height="32"  border="0"       /></a></div></td>
              </tr>
            </table></td>
            <td width="685" align="left"><table width="100%" border="0">
              ...
              <tr>
                ...
                <td><div align="left"><a href="../comercio/finalizar.php?id_prod=<?=encode5t($id_prod);?>"><img src="../graphics/finalizar_venda.png" width="169" height="65" border="0"></a></div></td>
				
				<?	
				    }else{
				    	
				?>    	
                <td><div align="left"><a href="../comercio/ativar.php?id_prod=<?=encode5t($id_prod);?>"><img src="../graphics/ativar_venda.png" width="169" height="65" border="0"></a></div></td>
				<?    	
              ...
              <tr>
                ...
                <td><div align="left"><a href="../comercio/pergunta.php?id_prod=<?=encode5t($id_prod);?>"><img src="../graphics/pergunta.png" width="166" height="32" border="0"></a></div></td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFCC" align="center">
     ...
     <td width="165" valign="middle" align="center"><font face="Verdana" size='1px'><b>Pergunta em</b>:<br>
       ...
       if ($ser_name3_c == strtoupper($vendedor)){
       	   if ($respondido != "SIM"){
       ?>
	      <a href="../comercio/responder.php?id_msg=<?=encode5t($id_msg);?>"><img src="../graphics/responder.png" width="70"  height="18" border="0" /></a>
	   <?
	   }
	   }
	   ?>
...
<center><a href="../comercio/pergunta.php?id_prod=<?=encode5t($id_prod);?>"><img id="Image3" src="../graphics/pergunta.png"  width="166"  height="32"  border="0" /></a></center>
			...
			<td width="186"><div align="center">
			  <?
                if ($nome_user_1 != $ser_name3_c){
		            ...
		            ?>
					   <br>
				       <a href="../comercio/comprar.php?id_prod=<?=encode5t($id_prod);?>"><img src="../graphics/loja_compra.png" width="169" height="65" border="0"/></a>	</div></td>
					<?
					}else{
					?>
...
?>
	...
	&nbsp;</td>
    <td><div align="center"><a href="meus_prod.php"><img src="../graphics/retorno.png" width="30" height="31" border="0"       /></a></div><br /></td>
