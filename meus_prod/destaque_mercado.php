...
<?
 ...
 //*********************************************************************
 $sql = "SELECT * FROM produto2 WHERE nome_user = '". $nome_user_1. "' AND excluido = 'NAO' ORDER BY RAND()"; // LIMIT 0,6
 GeraColunas(4, $sql);
...
echo ("<table width='50' height='60' border='0' cellpadding='0' cellspacing='1' align='center'>\n");
 ...
 $preco = number_format($linha[9],2,",",".");
  ...
  echo "<td align='center'><a href='descricao.php?id_prod=".$cod."'><img src='../".$img."' border='0' width='60' height='60' /></a></td>";
  echo "</tr>";
  
  echo "<tr>";
  echo "<td><div align='center' style='font-size:10px;font-family:Verdana'><strong><a href='descricao.php?id_prod=".$cod."&acao=incluir'>".$nome."</a></strong></div><strong><div align='center'><font color='#FF0000' size='2px'> R$ ".$preco." </font></strong>
