...
?>
        ...
        <td width="131" height="87" align="center"><div align="center"><a href="javascript:;" onClick="MM_openBrWindow('upload_foto.php?cod_prod=<?=$id0;?>&num_foto=0','','width=500,height=200')"><img id="Image2" src="<?=$fotos_dad;?>"  width="85"  height="95"  border="0"       /></a></div></td>
<?
}else{
?>	
...
?>        
        ...
        <td width="278"><div align="left">
          <table width="270" border="1">
            <tr>
              <td width="270" bordercolor="#000000" bgcolor="#FF9966"><font size="-2"><b><font color="#000000" face="Verdana">Para Alterar sua foto clique na foto </font></b></font></td>
            </tr>
          </table>
        </div></td>
        </tr>
    </table>
      <form id="Form1" name="Form1" method="post"  action="alterar.php?id_dados=<?=$id0;?>" onsubmit="return validaCampo(); return false;">
      <table border="0">
        <tr>
          <td height="379" align="left" bgcolor="#DDDCD9"><div align="left">              <table width="100%" border="0" cellpadding="0" cellspacing="1">
                ...
                <tr>
                  ...
                  <td align="left"><input type="text" id="Edit2" name="Edit2" value="<?=$Edit2;?>" style=" font-family: Verdana; font-size: 10px;  background-color: #FFFFFF;height:20px;width:208px;"    tabindex="2"    />

                    <font color="#FF0000">*</font></td>
                </tr>
                <tr>
                  <td height="31" align="left"><b><font size="-1" face="Verdana">Data de Nascimento .:</font></b></td>
                  <td align="left"><select type="text" id="Edit3" name="Edit3" value="<?=$Edit3;?>" style=" font-family: Verdana; font-size: 12px;  background-color: #FFFFFF;height:20px;width:45px;"    tabindex="3"    />
	<option value="<?=$Edit3;?>"> <?=$Edit3;?> </option>
            ...
            <option value="31"> 31   </option>
                    ...
                    <select type="text" id="Edit4" name="Edit4" value="<?=$Edit4;?>" style=" font-family: Verdana; font-size: 12px;  background-color: #FFFFFF;height:20px;width:45px;"    tabindex="4"    />
	...
	<option value="<?=$Edit4;?>"> <?=$Edit4;?> </option>
            ...
            <option value="12"> 12   </option>
                    ...
                    <img src="../graphics/px1.gif" width="5" height="1">
<select type="text" id="Edit5" name="Edit5" value="<?=$Edit5;?>" style=" font-family: Verdana; font-size: 12px;  background-color: #FFFFFF;height:20px;width:73px;"    tabindex="5"    />
	...
	<option value="<?=$Edit5;?>"> <?=$Edit5;?> </option>
            ...
            <option value="2009"> 2009   </option>
                ...
                <tr>
                  ...
                  <td align="left"><select type="text" id="Edit6" name="Edit6" value="<?=$Edit6;?>" style=" font-family: Verdana; font-size: 12px;  background-color: #FFFFFF;height:20px;width:147px;"    tabindex="6"    />
            ...
            <option value="FEMININO"> FEMININO   </option>
              ...
              <table width="100%" height="42" border="0">
                <tr>
                  ...
                  <td width="384" align="left"><input type="text"  name="Edit12" value="<?=$Edit12;?>"  style=" font-family: Verdana; font-size: 10px;  background-color: #FFFFFF;height:22px;width:300px;"   tabindex="0"    />
                ...
                <tr>
                  <td height="100" align="center" bgcolor="#DDDCD9"><table width="67%" border="0" cellpadding="0" cellspacing="1" bgcolor="#FFCC66">
                    <tr>
                      ...
                      <td width="59%"><input type="text" id="Edit7" name="Edit7" value="<?=$Edit7;?>" style=" font-family: Verdana; font-size: 10px;  background-color: #FFC082;height:20px;width:208px;"    readonly    />

                        <font color="#FF0000">*</font></td>
                    </tr>
                    <tr>
                      <td height="25"><b><font size="-1" face="Verdana">Senha .:</font></b></td>
                      <td><input type="password" id="Edit8" name="Edit8" value="<?=$Edit8;?>" style=" font-family: Verdana; font-size: 10px;  background-color: #FFFFFF;height:20px;width:171px;"    tabindex="9"    />

                        <font color="#FF0000">*</font></td>
                    </tr>
                    <tr>
                      <td height="25"><b><font size="-1" face="Verdana">Comfirmar Senha  .:</font></b></td>
                      <td><input type="password" id="Edit9" name="Edit9" value="<?=$Edit8;?>" style=" font-family: Verdana; font-size: 10px;  background-color: #FFFFFF;height:20px;width:171px;"    tabindex="9"    />
...
com foto de atores e pessoas publicas.. </font></b></div></td>
        ...
        <tr>
          <td bgcolor="#FFCC66">  		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
            <tr>
              ...
              <td width="66%"><input type="text" id="Edit10" name="Edit10" value="<?=$Edit10;?>" style=" font-family: Verdana; font-size: 10px;  background-color: #FFFFFF;height:20px;width:275px;"    tabindex="0" onblur="ValidaEmail()"   />

                <font color="#FF0000">*</font></td>
            </tr>
            <tr>
              <td height="31"><b><font size="-1" face="Verdana">Comfirmar e-Mails .:</font></b></td>
              <td><input type="text" id="Edit11" name="Edit11" value="<?=$Edit10;?>" style=" font-family: Verdana; font-size: 10px;  background-color: #FFFFFF;height:20px;width:275px;"    tabindex="0"  onblur="ValidaEmail2()"  />

                <font color="#FF0000">*</font></td>
            </tr>
            <tr>
              <td height="31"><b><font size="-1" face="Verdana">R.G .:</font></b></td>
              <td><input type="text" id="Edit13" name="Edit13" value="<?=$Edit13;?>" style=" font-family: Verdana; font-size: 10px;  background-color: #FFC082;height:20px;width:275px;"   readonly    />

                <font color="#FF0000">*</font></td>
            </tr>
            <tr>
              <td height="31"><b><font size="-1" face="Verdana">C.P.F .:</font></b></td>
              <td><input type="text" id="Edit14" name="Edit14" value="<?=$Edit14;?>" style=" font-family: Verdana; font-size: 10px;  background-color: #FFC082;height:20px;width:275px;"  readonly  maxlength="14" onblur="validarCPF()" />

                <font color="#FF0000">*</font></td>
            </tr>
            <tr>
              <td height="31"><b><font size="-1" face="Verdana">Tipo .:</font></b></td>
              <td><select type="text" id="Edit15" name="Edit15" value="<?=$Edit15;?>" style=" font-family: Verdana; font-size: 10px;  background-color: #FFFFFF;height:20px;width:163px;"    tabindex="0"    />
            ...
            <tr>
              ...
              <td><input type="text" id="Edit16" name="Edit16" value="<?=$Edit16;?>" style=" font-family: Verdana; font-size: 10px;  background-color: #FFFFFF;height:20px;width:275px;"    tabindex="0"    />
</td>
            </tr>
            <tr>
              <td height="31"><b><font size="-1" face="Verdana">Numero .:</font></b></td>
              <td><input type="text" id="Edit25" name="Edit25" value="<?=$Edit25;?>" style=" font-family: Verdana; font-size: 10px;  background-color: #FFFFFF;height:20px;width:175px;"    tabindex="0"    /></td>
            </tr>
            <tr>
              <td height="31"><b><font size="-1" face="Verdana">Bairro .:</font></b></td>
              <td><input type="text" id="Edit17" name="Edit17" value="<?=$Edit17;?>" style=" font-family: Verdana; font-size: 10px;  background-color: #FFFFFF;height:20px;width:275px;"    tabindex="0"    />
</td>
            </tr>
            <tr>
              <td height="31"><b><font size="-1" face="Verdana">Cidade .:</font></b></td>
              <td><input type="text" id="Edit18" name="Edit18" value="<?=$Edit18;?>" style=" font-family: Verdana; font-size: 10px;  background-color: #FFFFFF;height:20px;width:171px;"    tabindex="0"    />
</td>
            </tr>
            <tr>
              <td height="31"><b><font size="-1" face="Verdana">Estado .:</font></b></td>
              <td><select type="text" id="Edit24" name="Edit24" value="<?=$Edit24;?>" style=" font-family: Verdana; font-size: 10px;  background-color: #FFFFFF;height:20px;width:140px;"    tabindex="0"    />
		...
		?>  
            ...
            <tr>
              ...
              <td><input type="text" id="Edit19" name="Edit19" value="<?=$Edit19;?>" style=" font-family: Verdana; font-size: 10px;  background-color: #FFFFFF;height:20px;width:115px;" onkeypress="return txtBoxFormat(document.Form1, 'Edit19', '99999-999', event);"   tabindex="0"    />
</td>
            </tr>
          </table></td>
        </tr>
        ...
        <tr>
          <td height="98" bgcolor="#DDDCD9"><table width="100%" border="0">
            <tr>
              ...
              <td width="209" align="left"><input type="text" id="Edit21" name="Edit21" value="<?=$Edit21;?>" style=" font-family: Verdana; font-size: 10px;  background-color: #FFFFFF;height:20px;width:168px;" onkeypress="return txtBoxFormat(document.Form1, 'Edit21', '(99)9999-9999', event);"   tabindex="0"    />
</td>
            </tr>
          </table>
            <table width="100%" border="0">
              <tr>
                ...
                <td width="70%"><input type="text"  name="Edit22" value="<?=$Edit22;?>"  style=" font-family: Verdana; font-size: 10px;  background-color: #FFFFFF;height:22px;width:300px;"   tabindex="0"    />
</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
            ...
            <table width="100%" border="0">
  <tr>
    <td><b><font size="2" face="Verdana">&nbsp;&nbsp;&nbsp;&nbsp;Contrato e Termos de Uso do Compraai</font></b> </td>
  </tr>
</table>
...
Em determinados casos, serao mantidos nos arquivos do Compraai os Dados Pessoais que nos tenha sido solicitados para remoçao com o objetivo de utilizaçao na soluçao de litígios ou reclamaçoes, detectar problemas ou incidentes e e dar cumprimento ao disposto nos Termos e Condiçoes Gerais de Uso. Em qualquer caso, os Dados Pessoais do Usuário nao serao imediatamente retirados dos arquivos por razoes legais e técnicas, incluindo os sistemas de suporte e segurança.</textarea>
      ...
      <tr>
        <td width="100"><input id="Button1" name="Button1" type=image src="../graphics/alterar.png" width="100" height="32"></td>
                	</form>
        ...
        <?
        $icod_20 = encode5t($icod);
        
		if ($apag == "SIM"){
			
        ?>

        <form method="post"  action="ativar_dados.php?cod_dados=<?=$icod_20;?>">

        <td width="11"><input id="Button2" name="Button2" type=image src="../graphics/ativar.png" width="100" height="32"></td>
       </form> 
       <?
	   }else{
        ...
        <form method="post"  action="desativar.php?cod_dados=<?=$icod_20;?>">
