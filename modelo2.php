...
<table width="100%" height="602" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FC9107">
      <tr>
        <td width="174" align="center" valign="top" background="graphics/lixo1.png"><div align="center"><img src="graphics/port_3.gif" width="135" height="99"></div></td>
        <td width="521" valign="bottom" background="graphics/banner_sys1b.png"><table width="200" border="0" cellpadding="0" cellspacing="0">
          <tr>
        ...
        <td width="317">		<div align="center">
          <table width="201" border="0" cellpadding="0" cellspacing="0" background="graphics/area_user2.png" bgcolor="#FF850E">
            <tr>
              <td width="272">&nbsp;</td>
            </tr>
            <tr>
      ...
      <table width="100%" height="182%" border="0">
		...
		<tr>
		                ...
		                <TD vAlign=center 
                background="graphics/fundo_menu.gif" 
                height=30><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;&nbsp;<IMG height=9 
                  src="graphics/setinha_menu.gif" 
                  width=9>&nbsp;&nbsp;<A class=linkmenu 
                  href="<?=$progr_0;?>">HOME</A></font></b></TD>
...
 </td>
      ...
      <table width="100%" height="50" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="50" bgcolor="#FF850E">&nbsp;</td>
        </tr>
      </table>      </td>
  </tr>
</table>
